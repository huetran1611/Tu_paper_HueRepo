...
def main():
    ...
    parser.add_argument("--out-dir", default="round4_aggregate")
    ...
    all_runs_path = out_dir / "round4_all_runs.csv"
    ...
    (out_dir / "round4_best_config.json").write_text(json.dumps(best_json, indent=2) + "\n", encoding="utf-8")
    ...
    (out_dir / "round4_best_for_round5.fixed.args").write_text("\n".join(fixed_args) + "\n", encoding="utf-8")
    ...
    (out_dir / "round4_validation_report.json").write_text(
