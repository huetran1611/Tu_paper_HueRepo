...
//double height = 50.0; // height of the drone
double height = 0; // height of the drone
double power_beta = 0.0, power_gamma = 1.0; //coefficients for drone energy consumption per second
...
int main(int argc, char* argv[]) {
    ...
    for (int i = 1; i <= n; ++i) {
        // For testing: override deadlines and service times
        deadline[i] = 3600.0;
        serve_truck[i] = 0.0;
        serve_drone[i] = 0.0;
    }
...
// Run with : g++ -O3 -std=c++20 tabubu_old_config.cpp -o tabubu_old_config && ./tabubu_old_config instance/50.20.4.txt
